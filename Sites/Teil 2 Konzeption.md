...
Jeder neue Benutzer wird in Azure Entra ID von einem Administrator manuell erstellt. Dabei müssen grundlegende Informationen wie Benutzername, E-Mail und andere personenbezogene Daten von Hand eingegeben werden. Dies erfordert konzentration während der Eingabe, um spätere Korrekturen oder Unstimmigkeiten zu vermeiden.
...
### Integration von Azure und Camunda
   ...
   - API-Zugriff auf Azure Entra ID: Die Azure REST API muss in Python verwendet werden, um Benutzerkonten zu erstellen, Lizenzen zuzuweisen und Gruppenmitgliedschaften zu verwalten.
...
### Automatisierung mit Python-Skripten
   ...
   - Benutzeranlage: Ein Python-Skript kann mithilfe der Azure API automatisch einen neuen Benutzer erstellen.
   ...
   - Gruppenmanagement: Gruppenmitgliedschaften lassen sich ebenfalls automatisiert zuweisen. 
...
- Python-Skripte führen die API-Aufrufe an Azure aus und geben die Ergebnisse an Camunda zurück.

### Zusammenfassung der Anforderungen

- API-Kenntnisse: Azure API für Python und Camunda REST API.
...
- Beschreibung: Das manuelle Anlegen eines Benutzers in Azure kann durch ein Python-Skript automatisiert werden, das die Azure API verwendet. Dies beinhaltet die Erfassung und   Validierung der Benutzerdaten, die dann automatisch an Azure übergeben werden.
...
- Beschreibung: Basierend auf den Jobrollen und Abteilungsinformationen können Benutzer automatisch den entsprechenden Azure Gruppen zugewiesen werden, um Zugriff auf die benötigten Ressourcen zu erhalten. Camunda könnte den Gruppenzuweisungsprozess steuern, während Python-Skripte die tatsächlichen API-Aufrufe ausführen.
...
![Ist- und Soll](<../Pictures/Ist- und Soll Zustand.png>)
